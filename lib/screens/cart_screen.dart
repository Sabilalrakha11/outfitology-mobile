  ...
  Future<void> _fetchCartItems() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://outfitku.web.id/api/cart"), // 🚨 Pastiin IP ini bener
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(width: 70, height: 70, color: Colors.grey[200], child: Image.network('http://outfitku.web.id/storage/${product['gambar']}', fit: BoxFit.cover, errorBuilder: (c,e,s) => const Icon(Icons.broken_image))),
